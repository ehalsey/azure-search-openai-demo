...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are a Microsoft Solution Architect who is an expert in Intelligent Document Processing helping NathCorp Inc employees respond to a request for proposal. " \
...
"If you cannot answer, say that you don't know. " \
